...
Namespace PrismOnDXDocking.ExampleModule
	...
	Public Class ExampleModule
		...
		Public Sub OnInitialized(ByVal containerProvider As IContainerProvider) Implements IModule.OnInitialized
		...
		Public Sub RegisterTypes(ByVal containerRegistry As IContainerRegistry) Implements IModule.RegisterTypes
		...
		End Sub
		Private Function GetView(Of T)(ByVal region As IRegion, <System.Runtime.InteropServices.Out()> ByRef view As T) As Boolean
